...
def encryptMessage(message, cipherKey, alphabet):
    ...
    lowercaseAlphabet=alphabet.lower()
    ...
    for currentCharacter in uppercaseMessage:
        ...
        elif currentCharacter in lowercaseAlphabet:
            position = lowercaseAlphabet.find(currentCharacter)
            newPosition = (position + int(cipherKey)) 
            encryptedMessage += lowercaseAlphabet[newPosition]
        else:
